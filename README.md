...
graph TB
    subgraph HyperEVM
        SP[Sovereign Pool<br/>Valantis]
        ALM[HLEALM<br/>spread-based pricing]
        EWMA[TwoSpeedEWMA<br/>variance tracking]
        Quoter[HLEQuoter<br/>on-chain quotes]
        Lending[LendingModule<br/>yield optimization]
        Precompile[PrecompileLib]
    ...
    HC[HyperCore<br/>L1 Oracle]
    
    Precompile -->|L1 Oracle Read| HC
    
    style HyperEVM fill:#e1f5ff,stroke:#0066cc
    style HC fill:#ffe1e1,stroke:#cc0000
```
